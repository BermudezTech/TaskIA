    ...
    return (
        <html lang="en">
            <body className={inter.className}>
                <aside className="w-3/12 h-screen p-4 flex flex-col justify-between	">
                    {/* MAIN MENU */}
                    <div className="flex flex-col gap-4 ">
                        <NavBtn name="Inicio" icon="home" />
                        <NavBtn name="Inbox" icon="inbox" />
                        <NavBtn name="Hoy" icon="calendar" />
                        <NavBtn name="Proximamente" icon="calendarNext" />
                        <NavBtn name="En cualquier momento" icon="timePass" />
